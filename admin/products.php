...
if(isset($_POST['add_product'])){
   ...
   if($select_products->rowCount() > 0){
      ...
      if($image_size > 2000000){
         $message[] = 'tamanho do arquivo muito grande';
      }else{
...
<section class="add-products">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <input type="text" required placeholder="coloque o nome do produto" name="name" maxlength="100" class="box">
      <input type="number" min="0" max="9999999999" required placeholder="coloque o preço" name="price" onkeypress="if(this.value.length == 10) return false;" class="box">
      <select name="category" class="box" required>
         <option value="" disabled selected>selecionar categoria --</option>
         <option value="main dish">refeição principal</option>
