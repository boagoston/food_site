   ...
   if($old_pass != $empty_pass){
      if($old_pass != $prev_pass){
         ...
         if($new_pass != $empty_pass){
            ...
            $message[] = 'por favor colocar nova senha!';
         }
      }
   }
...
<section class="form-container">
   ...
   <form action="" method="POST">
      ...
      <input type="password" name="old_pass" maxlength="20" placeholder="coloque a senha antiga" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
      <input type="password" name="new_pass" maxlength="20" placeholder="coloque a nova senha" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
