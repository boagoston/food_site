...
<form action="" method="post">
   ...
   <div class="user-info">
      ...
      <a href="update_profile.php" class="btn">atualizar informaçoes</a>
      <h3>endereço de entrega</h3>
      <p><i class="fas fa-map-marker-alt"></i><span><?php if($fetch_profile['address'] == ''){echo 'por favor coloque seu endereço';}else{echo $fetch_profile['address'];} ?></span></p>
