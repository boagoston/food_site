...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="text" class="box" placeholder="complemento" required maxlength="50" name="flat">
      <input type="text" class="box" placeholder="numero da casa" required maxlength="50" name="building">
