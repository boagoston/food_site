...
<section class="orders">
   ...
   <?php
      if($user_id == ''){
         echo '<p class="empty">por favor entre com seu usuario para ver os pedidos</p>';
      }else{
   ...
   <div class="box">
      ...
      <p> status de pagamento: <span style="color:<?php if($fetch_orders['payment_status'] == 'pending'){ echo 'red'; }else{ echo 'green'; }; ?>"><?= $fetch_orders['payment_status']; ?></span> </p>
   </div>
   <?php
      }
      }else{
         echo '<p class="empty">sem pedidos adicionados ainda!</p>';
      }
      }
   ?>
